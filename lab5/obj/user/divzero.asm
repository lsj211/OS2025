...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800038:	52c50513          	addi	a0,a0,1324 # 800560 <main+0x3a>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80005a:	52a50513          	addi	a0,a0,1322 # 800580 <main+0x5a>
...
exit(int error_code) {
  ...
  800128:	46450513          	addi	a0,a0,1124 # 800588 <main+0x62>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80017c:	42878793          	addi	a5,a5,1064 # 8005a0 <main+0x7a>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001d4:	4f8a8a93          	addi	s5,s5,1272 # 8006c8 <main+0x1a2>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  8003f6:	42e78793          	addi	a5,a5,1070 # 800820 <error_string>
  ...
  80040a:	1ca60613          	addi	a2,a2,458 # 8005d0 <main+0xaa>
  ...
  80041c:	1a860613          	addi	a2,a2,424 # 8005c0 <main+0x9a>
  ...
  80048e:	12fd8d93          	addi	s11,s11,303 # 8005b9 <main+0x93>
  ...
  8004ca:	0f250513          	addi	a0,a0,242 # 8005b8 <main+0x92>
  ...
  8004de:	0ded8d93          	addi	s11,s11,222 # 8005b8 <main+0x92>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
main(void) {
  ...
  800528:	00001797          	auipc	a5,0x1
  80052c:	ad87a783          	lw	a5,-1320(a5) # 801000 <zero>
main(void) {
  800530:	e406                	sd	ra,8(sp)
    asm volatile("divw %0, %1, %2" : "=r"(result) : "r"(1), "r"(zero));
  800532:	4585                	li	a1,1
  800534:	02f5c5bb          	divw	a1,a1,a5
    cprintf("value is %d.\n", result);
  800538:	00000517          	auipc	a0,0x0
  80053c:	16050513          	addi	a0,a0,352 # 800698 <main+0x172>
  800540:	2581                	sext.w	a1,a1
  800542:	b5fff0ef          	jal	8000a0 <cprintf>
    
    // cprintf("value is %d.\n", 1 / zero);
    panic("FAIL: T.T\n");
  800546:	00000617          	auipc	a2,0x0
  80054a:	16260613          	addi	a2,a2,354 # 8006a8 <main+0x182>
  80054e:	45c1                	li	a1,16
  800550:	00000517          	auipc	a0,0x0
  800554:	16850513          	addi	a0,a0,360 # 8006b8 <main+0x192>
  800558:	acfff0ef          	jal	800026 <__panic>
