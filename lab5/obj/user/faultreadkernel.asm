...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800038:	52450513          	addi	a0,a0,1316 # 800558 <main+0x32>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80005a:	52250513          	addi	a0,a0,1314 # 800578 <main+0x52>
...
exit(int error_code) {
  ...
  800128:	45c50513          	addi	a0,a0,1116 # 800580 <main+0x5a>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80017c:	42078793          	addi	a5,a5,1056 # 800598 <main+0x72>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001d4:	508a8a93          	addi	s5,s5,1288 # 8006d8 <main+0x1b2>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  8003f6:	43e78793          	addi	a5,a5,1086 # 800830 <error_string>
  ...
  80040a:	1c260613          	addi	a2,a2,450 # 8005c8 <main+0xa2>
  ...
  80041c:	1a060613          	addi	a2,a2,416 # 8005b8 <main+0x92>
  ...
  80048e:	127d8d93          	addi	s11,s11,295 # 8005b1 <main+0x8b>
  ...
  8004ca:	0ea50513          	addi	a0,a0,234 # 8005b0 <main+0x8a>
  ...
  8004de:	0d6d8d93          	addi	s11,s11,214 # 8005b0 <main+0x8a>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
main(void) {
  ...
  800526:	3eb00793          	li	a5,1003
  80052a:	07da                	slli	a5,a5,0x16
  80052c:	438c                	lw	a1,0(a5)
main(void) {
  80052e:	1141                	addi	sp,sp,-16
    cprintf("I read %08x from 0xfac00000!\n", *(unsigned *)0xfac00000);
  800530:	00000517          	auipc	a0,0x0
  800534:	16050513          	addi	a0,a0,352 # 800690 <main+0x16a>
main(void) {
  800538:	e406                	sd	ra,8(sp)
    cprintf("I read %08x from 0xfac00000!\n", *(unsigned *)0xfac00000);
  80053a:	b67ff0ef          	jal	8000a0 <cprintf>
    panic("FAIL: T.T\n");
  80053e:	00000617          	auipc	a2,0x0
  800542:	17260613          	addi	a2,a2,370 # 8006b0 <main+0x18a>
  800546:	459d                	li	a1,7
  800548:	00000517          	auipc	a0,0x0
  80054c:	17850513          	addi	a0,a0,376 # 8006c0 <main+0x19a>
  800550:	ad7ff0ef          	jal	800026 <__panic>
