...
exit(int error_code) {
  ...
  8000ce:	43650513          	addi	a0,a0,1078 # 800500 <main+0x30>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800126:	3f678793          	addi	a5,a5,1014 # 800518 <main+0x48>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  80017e:	4c6a8a93          	addi	s5,s5,1222 # 800640 <main+0x170>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  8003a0:	3fc78793          	addi	a5,a5,1020 # 800798 <error_string>
  ...
  8003b4:	1a060613          	addi	a2,a2,416 # 800550 <main+0x80>
  ...
  8003c6:	17e60613          	addi	a2,a2,382 # 800540 <main+0x70>
  ...
  800438:	0fdd8d93          	addi	s11,s11,253 # 800531 <main+0x61>
  ...
  800474:	0c050513          	addi	a0,a0,192 # 800530 <main+0x60>
  ...
  800488:	0acd8d93          	addi	s11,s11,172 # 800530 <main+0x60>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
int
main(void) {
  8004d0:	1141                	addi	sp,sp,-16
  8004d2:	e406                	sd	ra,8(sp)
    cprintf("I am %d, print pgdir.\n", getpid());
  8004d4:	c05ff0ef          	jal	8000d8 <getpid>
  8004d8:	85aa                	mv	a1,a0
  8004da:	00000517          	auipc	a0,0x0
  8004de:	13e50513          	addi	a0,a0,318 # 800618 <main+0x148>
  8004e2:	b5dff0ef          	jal	80003e <cprintf>
    print_pgdir();
  8004e6:	bf5ff0ef          	jal	8000da <print_pgdir>
    cprintf("pgdir pass.\n");
  8004ea:	00000517          	auipc	a0,0x0
  8004ee:	14650513          	addi	a0,a0,326 # 800630 <main+0x160>
